...
C_SRCS += \
../source/servo/servo.c 

C_DEPS += \
./source/servo/servo.d 

OBJS += \
./source/servo/servo.o 


# Each subdirectory must supply rules for building sources it contributes
source/servo/%.o: ../source/servo/%.c source/servo/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-servo

clean-source-2f-servo:
	-$(RM) ./source/servo/servo.d ./source/servo/servo.o

.PHONY: clean-source-2f-servo
