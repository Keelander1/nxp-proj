...
C_SRCS += \
../source/display/adapter/disp_adapter.c \
../source/display/adapter/menu_adapter.c 

C_DEPS += \
./source/display/adapter/disp_adapter.d \
./source/display/adapter/menu_adapter.d 

OBJS += \
./source/display/adapter/disp_adapter.o \
./source/display/adapter/menu_adapter.o 


# Each subdirectory must supply rules for building sources it contributes
source/display/adapter/%.o: ../source/display/adapter/%.c source/display/adapter/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-display-2f-adapter

clean-source-2f-display-2f-adapter:
	-$(RM) ./source/display/adapter/disp_adapter.d ./source/display/adapter/disp_adapter.o ./source/display/adapter/menu_adapter.d ./source/display/adapter/menu_adapter.o

.PHONY: clean-source-2f-display-2f-adapter
