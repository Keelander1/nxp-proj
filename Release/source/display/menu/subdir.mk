...
C_SRCS += \
../source/display/menu/menu.c \
../source/display/menu/menu_rtos.c 

C_DEPS += \
./source/display/menu/menu.d \
./source/display/menu/menu_rtos.d 

OBJS += \
./source/display/menu/menu.o \
./source/display/menu/menu_rtos.o 


# Each subdirectory must supply rules for building sources it contributes
source/display/menu/%.o: ../source/display/menu/%.c source/display/menu/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-display-2f-menu

clean-source-2f-display-2f-menu:
	-$(RM) ./source/display/menu/menu.d ./source/display/menu/menu.o ./source/display/menu/menu_rtos.d ./source/display/menu/menu_rtos.o

.PHONY: clean-source-2f-display-2f-menu
