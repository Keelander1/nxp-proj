...
C_SRCS += \
../source/camera/camera.c 

C_DEPS += \
./source/camera/camera.d 

OBJS += \
./source/camera/camera.o 


# Each subdirectory must supply rules for building sources it contributes
source/camera/%.o: ../source/camera/%.c source/camera/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-camera

clean-source-2f-camera:
	-$(RM) ./source/camera/camera.d ./source/camera/camera.o

.PHONY: clean-source-2f-camera
