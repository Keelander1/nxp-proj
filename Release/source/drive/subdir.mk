...
C_DEPS += \
./source/drive/drive.d 

OBJS += \
./source/drive/drive.o 


# Each subdirectory must supply rules for building sources it contributes
source/drive/%.o: ../source/drive/%.c source/drive/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-drive

clean-source-2f-drive:
	-$(RM) ./source/drive/drive.d ./source/drive/drive.o

.PHONY: clean-source-2f-drive
