...
//Globally defined notes

uint32_t notes[] = {
	nE4, nG4, nA4, (1<<31), nA4, (1<<31),
	nA4, nB4, nC5, (1<<31), nC5, (1<<31),
	nC5, nD5, nB4, (1<<31), nB4, (1<<31),
	nA4, nG4, nA4, (1<<31),
	nE4, nG4, nA4, (1<<31), nA4, (1<<31),
	nA4, nB4, nC5, (1<<31), nC5, (1<<31),
	nC5, nD5, nB4, (1<<31), nB4, (1<<31),
	nA4, nG4, nA4, (1<<31),
	nE4, nG4, nA4, (1<<31), nA4, (1<<31),
	nA4, nC5, nD5, (1<<31), nD5, (1<<31),
	nD5, nE5, nF5, (1<<31), nF5, (1<<31),
	nE5, nD5, nE5, nA4, (1<<31),
	nA4, nB4, nC5, (1<<31), nC5, (1<<31),
	nD5, nE5, nA4, (1<<31),
	nA4, nC5, nB4, (1<<31),nB4, (1<<31),
	nC5, nA4, nB4, (1<<31),
	nE4, nG4, nA4, (1<<31), nA4, (1<<31),
	nA4, nB4, nC5, (1<<31), nC5, (1<<31),
	nC5, nD5, nB4, (1<<31), nB4, (1<<31),
	...
	nE5, (1<<31), nE5, (1<<31), nG5, (1<<31), nE5, nD5, (1<<31), (1<<31),
	...
	125, 125, 125, 125, 125, 125, 125, 125, 125, 375,
	250, 125, 375, 250, 125, 375,
...
uint32_t notes1[] = {
				...
				nB4, (1<<31), nB4, (1<<31), nB4, (1<<31), nC5, (1<<31), nC5, (1<<31), nC5, (1<<31), 			//12
				nD5, (1<<31), nD5, (1<<31), nE5, (1<<31), nE5, (1<<31),							//8
				nB4, (1<<31), nA4, (1<<31), nB4, (1<<31), nA4, (1<<31), nF4, (1<<31), nD4, (1<<31), nG4, (1<<31), nD4, (1<<31),		//16
				nF4, (1<<31), nB4, (1<<31), nC5, (1<<31), nD5, (1<<31), nF5, (1<<31), nD5, (1<<31), nG4, (1<<31), nA4, (1<<31), nG4, (1<<31), //18
				nG4, (1<<31), nF4, (1<<31), nG4, (1<<31), nF4, (1<<31), nE4, (1<<31),			//10
				nE5, (1<<31), nD5, (1<<31), nE5, (1<<31), nD5, (1<<31), nC5, (1<<31),			//10
				nD5, (1<<31), nB4, (1<<31), nE5, (1<<31), nD5, (1<<31), nB4, (1<<31), 			//10
				nE5, (1<<31), nD5, (1<<31), nB4, (1<<31), nE5, (1<<31), nD5, (1<<31), nB4, (1<<31), //12
				nA4, (1<<31), nF4, (1<<31), nB4, (1<<31)										//6
		};
uint32_t duration1[] = {
		...
		125, 125, 100, 50, 100, 50, 100, 50, 250, 50, 300, 125,
		125, 125, 100, 50, 200, 125, 500, 2300,
		375, 250, 125, 125, 125, 125, 200, 125, 250, 250, 125, 125, 125, 125, 500, 1000,
		100, 50, 375, 250, 125, 125, 125, 125, 125, 125, 250, 250, 100, 50, 100, 125, 375, 1000,
		375, 125, 250, 125, 125, 75, 375, 125, 375, 300,
		375, 125, 250, 125, 125, 75, 375, 125, 375, 300,
		375, 200, 125, 200, 100, 50, 375, 200, 125, 200,
		100, 50, 375, 200, 125, 200, 100, 50, 375, 200, 500, 750,
		125, 50, 100, 50, 500, 1000
};

void menu_page_Champions(uint8_t refresh){
	float songspeed = 1.3;
	for (uint8_t i=0;i<163;i++){
		uint32_t wait = duration1[i] * songspeed;
		MRT0->CHANNEL[1].INTVAL=(notes1[i]);
		if(notes1[i]==(1<<31)){
			vTaskDelay(1);
				GPIO->CLR[2] |=(1<<1); //Clear Buzzer
